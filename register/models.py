...
class UserManager(BaseUserManager):
    ...
    def _create_user(self, email, password,name,school,age,**extra_fields):
...
class Post(models.Model):
    ...
    pdfpass = models.CharField('pdfpass',max_length=255)
    topimg = models.CharField('topimg',max_length=255)
